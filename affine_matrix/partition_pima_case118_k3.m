function result = partition_pima_case118_k3(outputJson)
%PARTITION_PIMA_CASE118_K3 Compute a connected, balanced three-way split.
...
if outputJson == ""
    outputJson = fullfile(repoDir,'COPF','case118_clusters_k3.json');
end
