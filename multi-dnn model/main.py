...
The MATLAB generators in this folder save one-hot contingencies. To reproduce
...
def parse_args(argv: Optional[Iterable[str]] = None) -> argparse.Namespace:
    ...
    p.add_argument("--model", choices=("paper-table", "two-stage"), default="two-stage")
    p.add_argument("--epochs", type=int, default=200)
    p.add_argument("--seed", type=int, default=None, help="Random seed for reproducibility")
    p.add_argument("--batch-size", type=int, default=None)
    p.add_argument("--lr", type=float, default=None)
    p.add_argument("--cy", type=float, default=1.0, help="C^y in Equation (22)")
    p.add_argument("--cv", type=float, default=1.0, help="C^v in Equation (23)")
    p.add_argument("--cp", type=float, default=1.0, help="C^p in Equation (24)")
    p.add_argument("--cq", type=float, default=1.0, help="C^q in Equation (24)")
    p.add_argument("--rho", type=float, default=1e-3, help="Lagrange update factor")
    p.add_argument(
        "--loss-candidate",
        type=LossConfig.parse,
        action="append",
        default=None,
        metavar="CY,CV,CP,CQ,RHO",
